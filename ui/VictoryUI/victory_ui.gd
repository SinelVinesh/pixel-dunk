...
var frog_texture = "res://assets/ui/png/Background/background_frog.png"
var rabbit_texture = "res://assets/ui/png/Background/background_rabbit.png"
var common_texture = "res://assets/ui/png/Background/background_rabbit_vs_frog.png"
...
func initialize_victory_screen():
	...
	match winner :
		...
		Constants.Team.RABBIT :
			...
			$Winner1.play("rabbit_0")
			$Winner2.play("rabbit_1")
		Constants.Team.NONE :
			$Winner1.play("frog_0")
			$Winner2.play("rabbit_0")
